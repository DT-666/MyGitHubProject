...
<?php
	...
	try 
	{
		...
		else
		{
			...
			$count_DiD = getUserCaptureFromDiD($db, 'DT666', $timestampStart * 1000, $timestampEnd * 1000, $sleep);
			$count_DiD += getUserCaptureFromDiD($db, 'lkabibi', $timestampStart * 1000, $timestampEnd * 1000, $sleep);
			$count_DiD += getUserCaptureFromDiD($db, 'planar974', $timestampStart * 1000, $timestampEnd * 1000, $sleep);
			$count_DiD += getUserCaptureFromDiD($db, 'Tanchouille', $timestampStart * 1000, $timestampEnd * 1000, $sleep);
			
			$count_DiD += getUserCaptureFromDiD($db, 'porcy', $timestampStart * 1000, $timestampEnd * 1000, $sleep);
